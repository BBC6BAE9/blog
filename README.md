...
现有的欢迎文章在 `src/content/posts/hello/index.md`，可以按自己的表达习惯修改，或直接替换成第一篇正式文章。
...
**邮件订阅**通过 [follow.it](https://follow.it/) 读取博客 RSS，并把新文章发送给订阅者。订阅入口在接入完成后开放；读者按页面和邮件提示确认订阅，并可通过邮件退订。站点只需公开的订阅地址或表单配置，不需要放入邮件密码或 API 密钥。更换服务时，请同步更新订阅组件和隐私说明。
